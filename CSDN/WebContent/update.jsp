...
<body>
  ...
  int id = Integer.parseInt(request.getParameter("id")); 
	...
	<div id="nav">
		...
		<div class="container">
       <form action="updateart" name="upfile">
			<div>
			<div style="height: 50px; padding-top: 20px;display:inline;font-size:16px;">
					<span>博文标题:</span> <input type="text" name="title" value="${a.title }">
				</div>
  ...
  <script id="editor" type="text/plain" style="width:1024px;height:500px; center">
 ${a.content };
</script>
